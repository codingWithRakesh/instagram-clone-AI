...
const StoryViewSmall = ({opacity}) => {
  return (
    <div className={`h-[15.813rem] opacity-[${opacity}%] w-[8.875] relative flex items-center justify-center text-white rounded-[6px] overflow-hidden`}>
