...
import loader from "../assets/gif/loaderGif.gif"
...
const TakePost = ({loader}) => {
    return (
        <div className="upload overflow-hidden" id="postDiv">
            {loader ? <><div className="uploadTitle">Create new post</div>
            <div className="uploadFile">
                ...
                <div className="uploadTitle2">Drag photos and videos here</div>
                <div className="uploadSelect">
                    <label htmlFor="uploadItem">Select htmlForm computer</label>
            ...
            <div className='h-full w-full flex items-center justify-center flex-col gap-[1rem]'>
                ...
                <p className='text-2xl'>Your post has been shared.</p>
            </div>}
        </div>
    )
}
