...
const ExplorePost = ({ typeValue, classNameH }) => {
  return (
    <>
      {typeValue == "image" ? (<Link to="/p/sdlkfhlsf" className={`explorePost ${classNameH}`}>
        <img src={image} />
        ...
        :
        (<Link to="/p/jwhj83578" className={`explorePost ${classNameH}`}>
