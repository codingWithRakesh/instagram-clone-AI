...
const Sidebar = () => {
  ...
  useEffect(() => {
    console.log({ isCreatVisible, isNotoficationVisible, isSerachVisible,forMessage })
  }, [isCreatVisible, isNotoficationVisible, isSerachVisible,forMessage])
