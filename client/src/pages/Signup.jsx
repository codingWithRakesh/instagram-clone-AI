  ...
  return (
    <div className='flex items-center justify-center w-full minH paddingTopBottomP'>
      <div className='w-[22rem] minH flex flex-col items-center justify-start gap-2'>
        {isSignUp == "input" ? <SignUpMainInput inputsD={[setsignUpDetails, setSetsignUpDetails]} /> : isSignUp == "DOB" || isSignUp == "DOBB" ? <SignUpBirthday inputsD={[setsignUpDetails, setSetsignUpDetails]} /> : isSignUp == "OTP" ? <SignUpOTP inputsD={[setsignUpDetails, setSetsignUpDetails]} /> : null}
